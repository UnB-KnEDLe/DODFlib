...
def load_embedding_broked(train_path, embedding_path, embedding_size=50, **kwargs):
...
def load_embedding(dataset, base_path: Path, df: pd.DataFrame = None, tokens_col='ato'):
    print('base_path:', base_path)
    if dataset == 'aposentadoria':
        train_path = base_path / 'aposentadoria/aposentadoria_train.txt'
        test_path = base_path / 'aposentadoria/aposentadoria_testa.txt'
        data_format = 'iob2'
        ...
        train_path = base_path / '{0}/{0}_train.txt'.format(dataset)
        test_path = base_path / '{0}/{0}_test.txt'.format(dataset)
        data_format = 'iob2'
